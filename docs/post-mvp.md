...
- GitHub Gist sync for completion persistence (so localStorage wipe doesn't lose history)
- Import config button (paste JSON schedule without opening devtools)
